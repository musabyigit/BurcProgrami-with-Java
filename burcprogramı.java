...
public class burcprogramı 
{
    ...
    public static void main(String[] args) 
    {
       Scanner scan= new Scanner(System.in); // Kullanıcıdan giriş almamıza yarıyor.
        ...
        System.out.println("Dogum gününüzü (1-31 arasi) giriniz:"); // Dg(doğum günü)-Da(doğum ayı)-Dy(doğum yılı)[Dy değişkenine aslında gerek yok programın gidişatına bi etkisi yok çünkü]
